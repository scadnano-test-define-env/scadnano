define(['dart_sdk'], (function load__packages__quiver__core(dart_sdk) {
  ...
  hash.hashObjects = function hashObjects(objects) {
    return hash._finish(objects[$fold](T.intL(), 0, dart.fn((h, i) => hash._combine(h, dart.hashCode(i)), T.intLAnddynamicTointL())));
  };
  ...
  optional.Optional$ = dart.generic(T => {
    ...
    dart.setLibraryUri(Optional, I[0]);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["src/core/hash.dart","src/core/optional.dart","core.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;0CAeyB;AACrB,wBAAQ,AAAQ,OAAD,kBAAM,GAAG,SAAC,GAAG,MAAM,cAAS,CAAC,EAAI,cAAF,CAAC;EAAY;8BAGrD,GAAG;AAAM,wBAAQ,cAAS,cAAS,GAAK,cAAF,CAAC,IAAc,cAAF,CAAC;EAAW;8BAG/D,GAAG,GAAG;AAAM,wBAClB,cAAS,cAAS,cAAS,GAAK,cAAF,CAAC,IAAc,cAAF,CAAC,IAAc,cAAF,CAAC;EAAW;8BAG9D,GAAG,GAAG,GAAG;AAAM,wBAAQ,cAC7B,cAAS,cAAS,cAAS,GAAK,cAAF,CAAC,IAAc,cAAF,CAAC,IAAc,cAAF,CAAC,IACvD,cAAF,CAAC;EAAW;oCAIC,MAAU;AACS,IAAlC,OAAO,AAAW,YAAQ,aAAL,IAAI,iBAAG,KAAK;AACuB,IAAxD,OAAO,AAAW,YAAQ,aAAL,IAAI,KAAwB,CAAnB,AAAW,sBAAE,IAAI,MAAK;AACpD,UAAY,eAAL,IAAI,IAAI,AAAK,IAAD,cAAI;EACzB;kCAEgB;AACyC,IAAvD,OAAO,AAAW,YAAQ,aAAL,IAAI,KAAwB,CAAnB,AAAW,wBAAE,IAAI,MAAK;AAC1B,IAA1B,OAAY,cAAL,IAAI,IAAI,AAAK,IAAD,cAAI;AACvB,UAAO,AAAW,aAAQ,aAAL,IAAI,KAAwB,CAAnB,AAAW,qBAAE,IAAI,MAAK;EACtD;;;;;;;;;;;MCLU;;;;;;;AAGc,cAAA,AAAO;MAAO;;AAGX,cAAA,AAAO;MAAO;;AAMrC,YAAI,AAAO;AAC2C,UAApD,WAAM,wBAAW;;AAEnB,cAAO;MACT;gBAGoB;AAClB,sBAAI;AACe,UAAjB,AAAS,SAAA,CAAC;;MAEd;eAGmB;AACjB,uBAAK;AACO,UAAV,AAAQ,QAAA;;MAEZ;SAOO;;;AACL,YAAI,AAAa,YAAD;AACuC,UAArD,WAAM,2BAAc;;AAEtB,aAAO;4BAAU,YAAY;MAC/B;;AAGgB;MAAM;mBAOK;AACzB,cAAO,AAAO,yBACR,oDACA,4CAAe,AAAW,WAAA,CAAC;MACnC;2BAOmC;AACjC,cAAO,AAAO,yBACR,oDACA,sDAAyB,AAAW,WAAA,CAAC;MAC7C;;AAII,2CAAe,AAAS,kBAAR,6BAAmB,AAAoB;MAAQ;;AAI/C,cAAO,eAAP;MAAe;;YAIlB;AAAM,cAAE,AAAe,oBAAjB,CAAC,KAA4B,YAAT,AAAE,CAAD,WAAW;MAAM;;AAI3D,cAAO,AAAO,yBACR,wBACA,AAA6B,gCAAT,iBAAM;MAClC;;;MApGiC,eAAE;AAA7B;;IAAiC;4BAKzB;MAAgB,eAAE,KAAK;AAArC;AACE,UAAI,AAAO,uBAAS,AAAwC,WAAlC,2BAAc;IAC1C;sCAK8B;MAAgB,eAAE,KAAK;AAA/C;;IAA+C;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;6CCLlC,IAAI,IAAK,WAAI;AAEhC,QAAI,EAAE,UAAU,MAAO,GAAE;AACzB,QAAI,EAAE,UAAU,MAAO,GAAE;AACzB,QAAI,EAAE,UAAU,MAAO,GAAE;AACzB,QAAI,EAAE,UAAU,MAAO,GAAE;AACqB,IAA9C,WAAM,2BAAc;EACtB","file":"core.unsound.ddc.js"}');
  // Exports:
  return {
