define(['dart_sdk', 'packages/collection/src/utils'], (function load__packages__collection__src__algorithms(dart_sdk, packages__collection__src__utils) {
  ...
  algorithms.mergeSortBy = function mergeSortBy(E, K, elements, keyOf, compare, start = 0, end = null) {
    if (elements == null) dart.nullFailed(I[0], 247, 32, "elements");
    if (keyOf == null) dart.nullFailed(I[0], 247, 64, "keyOf");
    if (compare == null) dart.nullFailed(I[0], 248, 28, "compare");
    if (start == null) dart.nullFailed(I[0], 249, 10, "start");
    end = core.RangeError.checkValidRange(start, end, elements[$length]);
    let length = dart.notNull(end) - dart.notNull(start);
    if (length < 2) return;
    if (length < 32) {
  ...
  algorithms._movingInsertionSort = function _movingInsertionSort(E, K, list, keyOf, compare, start, end, target, targetOffset) {
    if (list == null) dart.nullFailed(I[0], 280, 13, "list");
    if (keyOf == null) dart.nullFailed(I[0], 281, 27, "keyOf");
    if (compare == null) dart.nullFailed(I[0], 282, 24, "compare");
    if (start == null) dart.nullFailed(I[0], 283, 9, "start");
    if (end == null) dart.nullFailed(I[0], 284, 9, "end");
    if (target == null) dart.nullFailed(I[0], 285, 13, "target");
    if (targetOffset == null) dart.nullFailed(I[0], 286, 9, "targetOffset");
    let length = dart.notNull(end) - dart.notNull(start);
    if (length === 0) return;
  ...
  algorithms._mergeSort = function _mergeSort(E, K, elements, keyOf, compare, start, end, target, targetOffset) {
    if (elements == null) dart.nullFailed(I[0], 316, 13, "elements");
    if (keyOf == null) dart.nullFailed(I[0], 317, 27, "keyOf");
    if (compare == null) dart.nullFailed(I[0], 318, 24, "compare");
    if (start == null) dart.nullFailed(I[0], 319, 9, "start");
    if (end == null) dart.nullFailed(I[0], 320, 9, "end");
    if (target == null) dart.nullFailed(I[0], 321, 13, "target");
    if (targetOffset == null) dart.nullFailed(I[0], 322, 9, "targetOffset");
    let length = dart.notNull(end) - dart.notNull(start);
    if (length < 32) {
  ...
  algorithms._merge = function _merge(E, K, keyOf, compare, firstList, firstStart, firstEnd, secondList, secondStart, secondEnd, target, targetOffset) {
    ...
    if (keyOf == null) dart.nullFailed(I[0], 352, 27, "keyOf");
    if (compare == null) dart.nullFailed(I[0], 353, 24, "compare");
    if (firstList == null) dart.nullFailed(I[0], 354, 13, "firstList");
    if (firstStart == null) dart.nullFailed(I[0], 355, 9, "firstStart");
    if (firstEnd == null) dart.nullFailed(I[0], 356, 9, "firstEnd");
    if (secondList == null) dart.nullFailed(I[0], 357, 13, "secondList");
    if (secondStart == null) dart.nullFailed(I[0], 358, 9, "secondStart");
    if (secondEnd == null) dart.nullFailed(I[0], 359, 9, "secondEnd");
    if (target == null) dart.nullFailed(I[0], 360, 13, "target");
    if (targetOffset == null) dart.nullFailed(I[0], 361, 9, "targetOffset");
    if (!(dart.notNull(firstStart) < dart.notNull(firstEnd))) dart.assertFailed(null, I[0], 363, 10, "firstStart < firstEnd");
    if (!(dart.notNull(secondStart) < dart.notNull(secondEnd))) dart.assertFailed(null, I[0], 364, 10, "secondStart < secondEnd");
  ...
  algorithms.quickSort = function quickSort(E, elements, compare, start = 0, end = null) {
    if (elements == null) dart.nullFailed(I[0], 403, 27, "elements");
    if (compare == null) dart.nullFailed(I[0], 403, 60, "compare");
    if (start == null) dart.nullFailed(I[0], 404, 10, "start");
    end = core.RangeError.checkValidRange(start, end, elements[$length]);
  ...
  algorithms.quickSortBy = function quickSortBy(E, K, list, keyOf, compare, start = 0, end = null) {
    if (list == null) dart.nullFailed(I[0], 417, 13, "list");
    if (keyOf == null) dart.nullFailed(I[0], 417, 41, "keyOf");
    if (compare == null) dart.nullFailed(I[0], 417, 71, "compare");
    if (start == null) dart.nullFailed(I[0], 418, 10, "start");
  ...
  algorithms._quickSort = function _quickSort(E, K, list, keyOf, compare, random, start, end) {
    if (list == null) dart.nullFailed(I[0], 423, 31, "list");
    if (keyOf == null) dart.nullFailed(I[0], 423, 59, "keyOf");
    if (compare == null) dart.nullFailed(I[0], 424, 28, "compare");
    if (random == null) dart.nullFailed(I[0], 424, 44, "random");
    if (start == null) dart.nullFailed(I[0], 424, 56, "start");
    if (end == null) dart.nullFailed(I[0], 424, 67, "end");
    let length = dart.notNull(end) - dart.notNull(start);
    while (length >= 24) {
