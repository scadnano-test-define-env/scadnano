define(['dart_sdk', 'packages/quiver/src/iterables/concat'], (function load__packages__quiver__src__collection__bimap(dart_sdk, packages__quiver__src__iterables__concat) {
  ...
  var T = {
    ...
    IterableOfObjectL: () => (T.IterableOfObjectL = dart.constFn(core.Iterable$(T.ObjectL())))(),
    IterableLOfObjectL: () => (T.IterableLOfObjectL = dart.constFn(dart.legacy(T.IterableOfObjectL())))(),
    intL: () => (T.intL = dart.constFn(dart.legacy(core.int)))(),
    TreeSearchL: () => (T.TreeSearchL = dart.constFn(dart.legacy(treeset.TreeSearch)))(),
    TreeSetL: () => (T.TreeSetL = dart.constFn(dart.legacy(treeset.TreeSet)))(),
    VoidToboolL: () => (T.VoidToboolL = dart.constFn(dart.fnType(T.boolL(), [])))(),
    dynamicToTL: () => (T.dynamicToTL = dart.constFn(dart.gFnType(T => {
  ...
  dart.defineLazy(CT, {
    ...
    get C3() {
      return C$[3] = dart.constList([C$[0] || CT.C0, C$[1] || CT.C1, C$[2] || CT.C2], T.TreeSearchL());
    },
    get C4() {
      return C$[4] = dart.fn(multimap._BaseMultimap._id, T.dynamicToTL());
    }
  }, false);
  var C$ = Array(5).fill(void 0);
  var I = [
    "package:quiver/src/collection/lru_map.dart",
    "org-dartlang-app:///packages/quiver/src/collection/lru_map.dart",
    "package:quiver/src/collection/delegates/iterable.dart",
    "package:quiver/src/collection/delegates/queue.dart",
    "package:quiver/src/collection/delegates/map.dart",
    "package:quiver/src/collection/treeset.dart",
    "package:quiver/src/collection/delegates/list.dart",
    "package:quiver/src/collection/multimap.dart",
    "package:quiver/src/collection/bimap.dart",
    "package:quiver/src/collection/delegates/set.dart"
  ];
  ...
  queue.DelegatingQueue$ = dart.generic(E => {
    ...
    dart.setLibraryUri(DelegatingQueue, I[3]);
  ...
  map.DelegatingMap$ = dart.generic((K, V) => {
    ...
    class DelegatingMap extends core.Object {
      ...
      addEntries(entries) {
        T.IterableLOfObjectL().as(entries);
    ...
    dart.setLibraryUri(DelegatingMap, I[4]);
  ...
  treeset.TreeSet$ = dart.generic(V => {
    class TreeSet extends collection.IterableBase$(dart.legacy(V)) {
      ...
      static new(opts) {
        ...
        comparator == null ? comparator = dart.fn((a, b) => T.intL().as(dart.dsend(a, 'compareTo', [b])), dart.fnType(T.intL(), [dart.legacy(V), dart.legacy(V)])) : null;
    ...
    dart.setLibraryUri(TreeSet, I[5]);
    dart.setFieldSignature(TreeSet, () => ({
      __proto__: dart.getFields(TreeSet.__proto__),
      comparator: dart.finalFieldType(dart.legacy(dart.fnType(dart.legacy(core.int), [dart.legacy(V), dart.legacy(V)])))
    }));
  ...
  dart.setLibraryUri(treeset.TreeSearch, I[5]);
  ...
  treeset.TreeSearch.LESS_THAN = C$[0] || CT.C0;
  treeset.TreeSearch.NEAREST = C$[1] || CT.C1;
  treeset.TreeSearch.GREATER_THAN = C$[2] || CT.C2;
  treeset.TreeSearch.values = C$[3] || CT.C3;
  ...
  treeset._TreeNode$ = dart.generic(V => {
    ...
    dart.setLibraryUri(_TreeNode, I[5]);
  ...
  treeset.AvlTreeSet$ = dart.generic(V => {
    ...
    class AvlTreeSet extends treeset.TreeSet$(dart.legacy(V)) {
      ...
      add(element) {
        let t1, t0, t0$, t0$0, t0$1, t0$2, t0$3, t0$4;
        VL().as(element);
        if (this[_root] == null) {
      ...
      nearest(object, opts) {
        VL().as(object);
        let nearestOption = opts && 'nearestOption' in opts ? opts.nearestOption : C$[1] || CT.C1;
      ...
      [_searchNearest](element, opts) {
        let t1, t0, t1$, t0$;
        VL().as(element);
        let option = opts && 'option' in opts ? opts.option : C$[1] || CT.C1;
    ...
    dart.setLibraryUri(AvlTreeSet, I[5]);
  ...
  treeset._AvlTreeIterator$ = dart.generic(V => {
    var VL = () => (VL = dart.constFn(dart.legacy(V)))();
    var VLAndVLTointL = () => (VLAndVLTointL = dart.constFn(dart.fnType(T.intL(), [VL(), VL()])))();
    var VLAndVLToLintL = () => (VLAndVLToLintL = dart.constFn(dart.legacy(VLAndVLTointL())))();
    ...
    (_AvlTreeIterator.__ = function(tree, opts) {
      ...
      this[_moveNext] = dart.fn(() => {
        ...
        if (this[_current] == null) {
          this.state = dart.test(this.reversed) ? -1 : 1;
        } else if ((t0 = this.tree, t1 = this[_current].object, t2 = this.anchorObject, VLAndVLToLintL().as(t0.comparator)(t1, t2)) === 0 && !dart.test(this.inclusive)) {
          this[_moveNext]();
        }
        return this.state === 0;
      }, T.VoidToboolL());
    ...
    dart.setLibraryUri(_AvlTreeIterator, I[5]);
  ...
  treeset.AvlNode$ = dart.generic(V => {
    ...
    dart.setLibraryUri(AvlNode, I[5]);
  ...
  list.DelegatingList$ = dart.generic(E => {
    ...
    dart.setLibraryUri(DelegatingList, I[6]);
  ...
  multimap.Multimap$ = dart.generic((K, V) => {
    ...
    dart.setLibraryUri(Multimap, I[7]);
    return Multimap;
  });
  ...
  multimap._BaseMultimap$ = dart.generic((K, V, C) => {
    ...
    class _BaseMultimap extends core.Object {
      ...
      contains(key, value) {
        let t0;
        return (t0 = this[_map$][$_get](key), t0 == null ? null : t0[$contains](value)) === true;
      }
      _get(key) {
        let t0;
    ...
    (_BaseMultimap.fromIterable = function(iterable, opts) {
      ...
      this[_map$] = new (LinkedMapOfKL$CL()).new();
      key == null ? key = dart.gbind(C$[4] || CT.C4, KL()) : null;
      value == null ? value = dart.gbind(C$[4] || CT.C4, VL()) : null;
    ...
    dart.setLibraryUri(_BaseMultimap, I[7]);
  ...
  multimap.ListMultimap$ = dart.generic((K, V) => {
    ...
    var VL = () => (VL = dart.constFn(dart.legacy(V)))();
    var JSArrayOfVL = () => (JSArrayOfVL = dart.constFn(_interceptors.JSArray$(VL())))();
    var VLToboolL = () => (VLToboolL = dart.constFn(dart.fnType(T.boolL(), [VL()])))();
    var _WrappedListOfObjectL$VL = () => (_WrappedListOfObjectL$VL = dart.constFn(multimap._WrappedList$(T.ObjectL(), VL())))();
    ...
    dart.setLibraryUri(ListMultimap, I[7]);
    return ListMultimap;
  });
  ...
  multimap.SetMultimap$ = dart.generic((K, V) => {
    ...
    var VLToboolL = () => (VLToboolL = dart.constFn(dart.fnType(T.boolL(), [VL()])))();
    var _WrappedSetOfObjectL$VL = () => (_WrappedSetOfObjectL$VL = dart.constFn(multimap._WrappedSet$(T.ObjectL(), VL())))();
    var SetOfVL = () => (SetOfVL = dart.constFn(core.Set$(VL())))();
    var SetLOfVL = () => (SetLOfVL = dart.constFn(dart.legacy(SetOfVL())))();
    ...
    dart.setLibraryUri(SetMultimap, I[7]);
    return SetMultimap;
  });
  ...
  multimap._WrappedMap$ = dart.generic((K, V, C) => {
    ...
    dart.setLibraryUri(_WrappedMap, I[7]);
  ...
  multimap._WrappedIterable$ = dart.generic((K, V, C) => {
    ...
    dart.setLibraryUri(_WrappedIterable, I[7]);
  ...
  multimap._WrappedList$ = dart.generic((K, V) => {
    ...
    dart.setLibraryUri(_WrappedList, I[7]);
  ...
  multimap._WrappedSet$ = dart.generic((K, V) => {
    ...
    dart.setLibraryUri(_WrappedSet, I[7]);
  ...
  bimap.HashBiMap$ = dart.generic((K, V) => {
    ...
    var IterableOfMapEntryLOfKL$VL = () => (IterableOfMapEntryLOfKL$VL = dart.constFn(core.Iterable$(MapEntryLOfKL$VL())))();
    var IterableLOfMapEntryLOfKL$VL = () => (IterableLOfMapEntryLOfKL$VL = dart.constFn(dart.legacy(IterableOfMapEntryLOfKL$VL())))();
    var VLAndKLToboolL = () => (VLAndKLToboolL = dart.constFn(dart.fnType(T.boolL(), [VL(), KL()])))();
    var KLAndVLToLVL = () => (KLAndVLToLVL = dart.constFn(dart.legacy(KLAndVLToVL())))();
    var VL = () => (VL = dart.constFn(dart.legacy(V)))();
    var VoidToVL = () => (VoidToVL = dart.constFn(dart.fnType(VL(), [])))();
    var VoidToLVL = () => (VoidToLVL = dart.constFn(dart.legacy(VoidToVL())))();
    ...
    dart.setLibraryUri(HashBiMap, I[8]);
  ...
  set.DelegatingSet$ = dart.generic(E => {
    ...
    dart.setLibraryUri(DelegatingSet, I[9]);
