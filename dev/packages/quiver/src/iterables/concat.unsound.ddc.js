define(['dart_sdk'], (function load__packages__quiver__src__iterables__concat(dart_sdk) {
  ...
  var T$ = {
    ...
    SyncIterableOfnumL: () => (T$.SyncIterableOfnumL = dart.constFn(_js_helper.SyncIterable$(T$.numL())))(),
    IndexedValueL: () => (T$.IndexedValueL = dart.constFn(dart.legacy(enumerate.IndexedValue)))()
  };
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.fn(core.Comparable.compare, T$.ComparableAndComparableToint());
    }
  }, false);
  var C = Array(2).fill(void 0);
  var I = [
    "package:quiver/src/iterables/merge.dart",
    "package:quiver/src/iterables/enumerate.dart",
    "package:quiver/src/iterables/infinite_iterable.dart",
    "package:quiver/src/iterables/count.dart",
    "package:quiver/src/iterables/partition.dart",
    "package:quiver/src/iterables/cycle.dart",
    "package:quiver/src/iterables/generating_iterable.dart",
    "package:quiver/src/iterables/min_max.dart"
  ];
  ...
  merge._Merge$ = dart.generic(T => {
    ...
    dart.setFieldSignature(_Merge, () => ({
      ...
      [_compare$]: dart.finalFieldType(dart.legacy(dart.fnType(dart.legacy(core.int), [dart.legacy(T), dart.legacy(T)])))
    }));
  ...
  merge._IteratorPeeker$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_IteratorPeeker, I[0]);
  ...
  merge._MergeIterator$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_MergeIterator, I[0]);
  ...
  merge.merge = function merge$(T, iterables, compare = null) {
    let t0;
    if (dart.test(iterables[$isEmpty])) return C[0] || CT.C0;
    if (dart.test(iterables[$every](dart.fn(i => i[$isEmpty], dart.fnType(T$.boolL(), [dart.legacy(core.Iterable$(dart.legacy(T)))]))))) return C[0] || CT.C0;
    return new (merge._Merge$(dart.legacy(T))).new(iterables, dart.legacy(dart.fnType(T$.intL(), [dart.legacy(T), dart.legacy(T)])).as((t0 = compare, t0 == null ? C[1] || CT.C1 : t0)));
  };
  range.range = function range$(startOrStop, stop = null, step = null) {
    return new (T$.SyncIterableOfnumL()).new(() => (function* range(stop, step) {
  ...
  zip.zip = function zip$(T, iterables) {
    return new (_js_helper.SyncIterable$(dart.legacy(core.List$(dart.legacy(T))))).new(function* zip() {
      ...
      while (dart.test(iterators[$every](dart.fn(e => e.moveNext(), dart.fnType(T$.boolL(), [dart.legacy(core.Iterator$(dart.legacy(T)))]))))) {
  ...
  enumerate.IndexedValue$ = dart.generic(V => {
    class IndexedValue extends core.Object {
      ...
      _equals(other) {
        ...
        return T$.IndexedValueL().is(other) && other.index == this.index && dart.equals(other.value, this.value);
      }
      get hashCode() {
    ...
    dart.setLibraryUri(IndexedValue, I[1]);
  ...
  enumerate.EnumerateIterable$ = dart.generic(V => {
    ...
    dart.setLibraryUri(EnumerateIterable, I[1]);
  ...
  enumerate.EnumerateIterator$ = dart.generic(V => {
    ...
    dart.setLibraryUri(EnumerateIterator, I[1]);
  ...
  infinite_iterable.InfiniteIterable$ = dart.generic(T => {
    ...
    dart.setLibraryUri(InfiniteIterable, I[2]);
  ...
  dart.setLibraryUri(count._Count, I[3]);
  ...
  dart.setLibraryUri(count._CountIterator, I[3]);
  ...
  partition._Partition$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_Partition, I[4]);
  ...
  partition._PartitionIterator$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_PartitionIterator, I[4]);
  ...
  cycle._CycleIterator$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_CycleIterator, I[5]);
  ...
  generating_iterable.GeneratingIterable$ = dart.generic(T => {
    ...
    dart.setLibraryUri(GeneratingIterable, I[6]);
  ...
  generating_iterable._GeneratingIterator$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_GeneratingIterator, I[6]);
  ...
  min_max.max = function max(T, i, compare = null) {
    ...
    let _compare = dart.legacy(dart.fnType(T$.intL(), [dart.legacy(T), dart.legacy(T)])).as((t0 = compare, t0 == null ? C[1] || CT.C1 : t0));
