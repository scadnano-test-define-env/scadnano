define(['dart_sdk'], (function load__packages__term_glyph__src__generated__ascii_glyph_set(dart_sdk) {
  ...
  var I = [
    "org-dartlang-app:///packages/term_glyph/src/generated/unicode_glyph_set.dart",
    "package:term_glyph/src/generated/unicode_glyph_set.dart",
    "package:term_glyph/src/generated/glyph_set.dart",
    "org-dartlang-app:///packages/term_glyph/term_glyph.dart",
    "org-dartlang-app:///packages/term_glyph/src/generated/ascii_glyph_set.dart",
  ...
  unicode_glyph_set.UnicodeGlyphSet = class UnicodeGlyphSet extends core.Object {
    glyphOrAscii(glyph, alternative) {
      if (glyph == null) dart.nullFailed(I[0], 16, 30, "glyph");
      if (alternative == null) dart.nullFailed(I[0], 16, 44, "alternative");
      return glyph;
    }
    get bullet() {
      return "•";
  ...
  dart.setLibraryUri(unicode_glyph_set.UnicodeGlyphSet, I[1]);
  ...
  dart.setLibraryUri(glyph_set.GlyphSet, I[2]);
  ...
  term_glyph.glyphOrAscii = function glyphOrAscii(glyph, alternative) {
    if (glyph == null) dart.nullFailed(I[3], 36, 28, "glyph");
    if (alternative == null) dart.nullFailed(I[3], 36, 42, "alternative");
  ...
  dart.copyProperties(term_glyph, {
    ...
    set ascii(value) {
      if (value == null) dart.nullFailed(I[3], 30, 16, "value");
  ...
  ascii_glyph_set.AsciiGlyphSet = class AsciiGlyphSet extends core.Object {
    glyphOrAscii(glyph, alternative) {
      if (glyph == null) dart.nullFailed(I[4], 16, 30, "glyph");
      if (alternative == null) dart.nullFailed(I[4], 16, 44, "alternative");
      return alternative;
    }
    get bullet() {
      return "*";
  ...
  dart.setLibraryUri(ascii_glyph_set.AsciiGlyphSet, I[5]);
