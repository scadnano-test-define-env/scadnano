define(['dart_sdk', 'packages/string_scanner/src/eager_span_scanner', 'packages/source_span/source_span', 'packages/collection/src/canonicalized_map', 'packages/typed_data/src/typed_buffer'], (function load__packages__http_parser__http_parser(dart_sdk, packages__string_scanner__src__eager_span_scanner, packages__source_span__source_span, packages__collection__src__canonicalized_map, packages__typed_data__src__typed_buffer) {
  ...
  var T$ = {
    ...
    AuthenticationChallengeL: () => (T$.AuthenticationChallengeL = dart.constFn(dart.legacy(authentication_challenge.AuthenticationChallenge)))(),
    ListOfAuthenticationChallengeL: () => (T$.ListOfAuthenticationChallengeL = dart.constFn(core.List$(T$.AuthenticationChallengeL())))(),
    ListLOfAuthenticationChallengeL: () => (T$.ListLOfAuthenticationChallengeL = dart.constFn(dart.legacy(T$.ListOfAuthenticationChallengeL())))(),
    IdentityMapOfStringL$StringL: () => (T$.IdentityMapOfStringL$StringL = dart.constFn(_js_helper.IdentityMap$(T$.StringL(), T$.StringL())))(),
    VoidToAuthenticationChallengeL: () => (T$.VoidToAuthenticationChallengeL = dart.constFn(dart.fnType(T$.AuthenticationChallengeL(), [])))(),
    VoidToListLOfAuthenticationChallengeL: () => (T$.VoidToListLOfAuthenticationChallengeL = dart.constFn(dart.fnType(T$.ListLOfAuthenticationChallengeL(), [])))(),
    ...
    intLAndStringLTovoid: () => (T$.intLAndStringLTovoid = dart.constFn(dart.fnType(dart.void, [T$.intL(), T$.StringL()])))()
  };
  ...
  dart.defineLazy(CT, {
    ...
    get C3() {
      return C[3] = dart.constList([], T$.intL());
    },
    get C4() {
  ...
  authentication_challenge.AuthenticationChallenge = class AuthenticationChallenge extends core.Object {
    ...
    static parseHeader(header) {
      return utils.wrapFormatException(T$.ListLOfAuthenticationChallengeL(), "authentication header", header, dart.fn(() => {
        let scanner = new string_scanner.StringScanner.new(header);
        scanner.scan(scan.whitespace);
        let challenges = scan.parseList(T$.AuthenticationChallengeL(), scanner, dart.fn(() => {
        ...
        }, T$.VoidToAuthenticationChallengeL()));
        scanner.expectDone();
        return challenges;
      }, T$.VoidToListLOfAuthenticationChallengeL()));
    }
    static parse(challenge) {
      return utils.wrapFormatException(T$.AuthenticationChallengeL(), "authentication challenge", challenge, dart.fn(() => {
  ...
  (authentication_challenge.AuthenticationChallenge.new = function(scheme, parameters) {
    this[scheme$] = scheme;
    this[parameters$] = new (T$.UnmodifiableMapViewOfStringL$StringL()).new(new (T$.CaseInsensitiveMapOfStringL()).from(parameters));
    ;
  ...
  case_insensitive_map.CaseInsensitiveMap$ = dart.generic(V => {
    ...
    (CaseInsensitiveMap.new = function() {
      CaseInsensitiveMap.__proto__.new.call(this, dart.fn(key => key[$toLowerCase](), T$.StringLToStringL()), {isValidKey: dart.fn(key => key != null, T$.StringLToboolL())});
      ;
    }).prototype = CaseInsensitiveMap.prototype;
    (CaseInsensitiveMap.from = function(other) {
      CaseInsensitiveMap.__proto__.from.call(this, other, dart.fn(key => key[$toLowerCase](), T$.StringLToStringL()), {isValidKey: dart.fn(key => key != null, T$.StringLToboolL())});
      ;
    }).prototype = CaseInsensitiveMap.prototype;
    ...
    toString() {
      ...
      this.parameters[$forEach](dart.fn((attribute, value) => {
        ...
        if (dart.test(scan.nonToken.hasMatch(value))) {
          ...
          (() => {
            t2.write("\"");
            t2.write(value[$replaceAllMapped](media_type._escapedChar, dart.fn(match => "\\" + dart.str(match._get(0)), T$.MatchLToStringL())));
            t2.write("\"");
            return t2;
          })();
        } else {
  ...
  (media_type.MediaType.new = function(type, subtype, parameters = null) {
    ...
    this[parameters$0] = new (T$.UnmodifiableMapViewOfStringL$StringL()).new(parameters == null ? new (T$.IdentityMapOfStringL$StringL()).new() : new (T$.CaseInsensitiveMapOfStringL()).from(parameters));
    ;
  ...
  encoder._convert = function _convert(bytes, start, end, opts) {
    ...
    if (end == start) return dart.test(isLast) ? encoder._doneChunk : C[3] || CT.C3;
  ...
  dart.defineLazy(encoder, {
    ...
    /*encoder._doneChunk*/get _doneChunk() {
      return _native_typed_data.NativeUint8List.fromList(T$.JSArrayOfintL().of([48, 13, 10, 13, 10]));
    }
  }, true);
  ...
  decoder._Sink = class _Sink extends convert.ByteConversionSinkBase {
    ...
    [_decode](bytes, start, end) {
      ...
      dart.fn(assertCurrentChar, T$.intLAndStringLTovoid());
      ...
      while (start != end) {
        switch (this[_state]) {
          ...
          case C[8] || CT.C8:
          {
            let chunkEnd = math.min(T$.intL(), end, dart.notNull(start) + dart.notNull(this[_size]));
